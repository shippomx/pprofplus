...
```
go get github.com/shippomx/pprofplus
```

To run the tests, do

```
cd $GOPATH/src/github.com/shippomx/pprofplus
go test -v ./...
```
...
remote in the same `github.com/shippomx/pprofplus` directory. Otherwise, if you'll `go
